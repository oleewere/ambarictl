...
Using wget:
```bash
wget -qO- https://github.com/oleewere/ambarictl/releases/download/v0.2.1/ambarictl_0.2.1_linux_64-bit.tar.gz | tar -C /usr/bin -zxv ambarictl
```

Using curl:
```bash
curl -L -s https://github.com/oleewere/ambarictl/releases/download/v0.2.1/ambarictl_0.2.1_linux_64-bit.tar.gz | tar -C /usr/bin -xzv ambarictl
```
